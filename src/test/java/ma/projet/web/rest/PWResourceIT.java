...
class PWResourceIT {
    ...
    void createPW() throws Exception {
        ...
        restPWMockMvc
            .perform(
                post(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(pW))
            )
    ...
    void putNonExistingPW() throws Exception {
        ...
        restPWMockMvc
            .perform(
                put(ENTITY_API_URL_ID, pW.getId())
                    .with(csrf())
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    void putWithMissingIdPathParamPW() throws Exception {
        ...
        restPWMockMvc
            .perform(
                put(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(pW))
            )
    ...
    void partialUpdatePWWithPatch() throws Exception {
        ...
        partialUpdatedPW.title(UPDATED_TITLE).objectif(UPDATED_OBJECTIF);
    ...
    void deletePW() throws Exception {
        ...
        // Delete the pW
        restPWMockMvc
            .perform(delete(ENTITY_API_URL_ID, pW.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
